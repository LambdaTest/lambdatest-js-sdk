...
class UrlTrackerLogger {
  ...
  apiUpload(message) {
    ...
    console.log(
      this.formatMessage("api", `${apiPrefix} ${message}`, colors.teal)
    );
  }
  ...
  navigation(message) {
    ...
    console.log(
      this.formatMessage("nav", `${navPrefix} ${message}`, colors.teal)
    );
  }
  ...
  init(message) {
    ...
    console.log(
      this.formatMessage("init", `${initPrefix} ${message}`, colors.teal)
    );
  }
  ...
  cleanup(message) {
    ...
    console.log(
      this.formatMessage("cleanup", `${cleanupPrefix} ${message}`, colors.teal)
    );
  }
  ...
  export(message) {
    ...
    console.log(
      this.formatMessage("export", `${exportPrefix} ${message}`, colors.teal)
    );
  }
